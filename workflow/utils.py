...
def dump_configurations():
    models = [
        'workflow.Workflow',
        'workflow.reducechoices',
        'workflow.informchoices',
        'workflow.removechoices',
        'workflow.judgmentrequirementchoices',
        'workflow.corroboratingchoices',
    ]
    call_command('dumpdata', *models, indent=2,
                 output='fixtures/configurations.json')


def dump_labels():
    models = [
        'workflow.LabelingAnswer',
        'workflow.ItemURLs'
    ]
    call_command('dumpdata', *models, indent=2,
                 output='fixtures/labels.json')
